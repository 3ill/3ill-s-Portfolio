      ...
      >
        ...
        <div>
          <h1 className={`${styles.heroHeadText} text-white`}>
            Hi, I'm <span className="text-[#915eff]">Chikezie</span>
          </h1>
          <p className={`${styles.heroSubText} mt-2  text-white`}>
            I develop, audit and deploy smart <br className="sm:block hidden" />{" "}
            contracts for Decentralized Applications (Dapps)
          </p>
        </div>
      </div>
      <ComputersCanvas />
